          ...
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="mb-4 text-3xl font-medium capitalze text-white">
              ...
              <p className="text-default-200 text-sm font-medium">
                Now you can create Solana token to without code instanly
              </p>
          </div>
             ...
             className={`w-auto grow border-b border-white/10 md:w-1/2 ${
              ...
              <div className="p-8 sm:p-10">
                ...
                <a onClick={()=> list.function(true)}
                  className="hover:bg-primary inline-flex items-center justify-center
                  gap-2 rounded-full border border-white/10 px-6 py-2 text-white transition-all
                  duration-300">
                    Use Tools
                    <i>
